 ...
 * Hovering — or selecting the service (card, marker or click) — shows a rising light aura around the zone (`aura` can turn it off
...
export default function HitBox({ serviceId, position, args, aura = true }) {
  ...
  return (
    <group>
      ...
      {aura && (
        <HoverAura
          active={hover || selectedId === serviceId}
