...
export const strings = {
  th: {
    ...
    loading: { title: 'KHOME SMART', sub: 'Initializing Smart Environment…' },
    fallback: {
    ...
    sections: {
      ...
      why: {
        kicker: '03 — WHY KHOME SMART',
        title: 'ทำไมต้อง KHOME SMART',
        items: [
